...
export default async function Component({searchParams}: {searchParams: { name: string, category: string, minPrice: string, page: string}}) {
  ...
  const products = await getProducts(page, search, minPrice, category)
